deasync
=======
deasync turns async function into sync with a blocking mechanism by way of exposing Node.js event loop to JavaScript layer. The core of deasync is writen in C++.
